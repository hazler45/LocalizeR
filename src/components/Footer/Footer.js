          ...
          <div class="flex  gap-6 sm:gap-12 sm:grid-cols-3">
              <div >
                  ...
                  <ul class="text-gray-400 font-medium">
                      <li class="mb-4">
                          <Link to="" class="hover:underline">Service1</Link>
                      </li>
                      <li class="mb-4">
                          <Link to="" class="hover:underline">Service2</Link>
                      </li>
                      <li>
                          <Link to="" class="hover:underline">Service3</Link>
                      </li>
                  </ul>
                  
              </div>
              <div >
                  <h2 class=" mb-6 text-sm font-semibold  uppercase text-gray-900 ">Services</h2>
                  <ul class="text-gray-400 font-medium">
                      <li class="mb-4">
                          <Link to="" class="hover:underline">Service1</Link>
                      </li>
              ...
              <div>
                  <h2 class="mb-6 text-sm font-semibold text-white uppercase ">Others</h2>
                  <ul class="text-gray-400 font-medium">
                      <li class="mb-4">
